...
struct Command_
{
  ...
  _Fmax_type Fmax;
   ...
   typedef float _touch_time_type;
  _touch_time_type touch_time;
...
struct MD5Sum< ::control::Command_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xe6faae430874a340ULL;
  static const uint64_t static_value2 = 0xa970ebe0cee6bc1fULL;
};
...
struct Printer< ::control::Command_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::control::Command_<ContainerAllocator>& v)
  {
    ...
    s << indent << "touch_time: ";
    Printer<float>::stream(s, indent + "  ", v.touch_time);
  }
};
