...
(cl:defmethod cl:initialize-instance :after ((m <Fgrf>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Fgrf)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name strategy-msg:<Fgrf> is deprecated: use strategy-msg:Fgrf instead.")))

(cl:ensure-generic-function 'all_force-val :lambda-list '(m))
(cl:defmethod all_force-val ((m <Fgrf>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader strategy-msg:all_force-val is deprecated.  Use strategy-msg:all_force instead.")
  (all_force m))

(cl:ensure-generic-function 'stance_flg-val :lambda-list '(m))
(cl:defmethod stance_flg-val ((m <Fgrf>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader strategy-msg:stance_flg-val is deprecated.  Use strategy-msg:stance_flg instead.")
  (stance_flg m))
