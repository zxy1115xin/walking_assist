...
class LeftLat(Strategy):
    def __init__(self):
        super(LeftLat, self).__init__()
    ...
    def force_curve(self, t):
        ...
        if self.GRF_L.stance_flg == 1 and self.Last_flag == 0:
            ...
            if self.show_index == 1:  # 是否展示参数指令，评价力曲线是否达到期望步态百分比
                ...
                rospy.loginfo(" Left lat--> Tfmax = %f ; Finsh = %d  \t",  FmaX_time,self.stance_finsh)
